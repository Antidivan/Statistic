...
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_SITE_ORDER foreign key (SITE_ORDER_ID) references STATISTICSPROJECTRC_SITES(ID)^
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_PAYMENT_METHOD foreign key (PAYMENT_METHOD_ID) references STATISTICSPROJECTRC_PAYMENT_METHODS(ID)^
...
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_PRODUCT foreign key (PRODUCT_ID) references STATISTICSPROJECTRC_FORM_DURATION_COST(ID)^
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_CONSULTANT foreign key (CONSULTANT_ID) references STATISTICSPROJECTRC_CONSULTANTS(ID)^
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_CUSTOMER foreign key (CUSTOMER_ID) references STATISTICSPROJECTRC_CUSTOMERS(ID)^
alter table STATISTICSPROJECTRC_ORDERS add constraint FK_STATISTICSPROJECTRC_ORDERS_ON_TOWN foreign key (TOWN_ID) references STATISTICSPROJECTRC_TOWNS(ID)^
