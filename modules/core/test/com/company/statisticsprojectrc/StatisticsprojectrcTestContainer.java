package com.company.statisticsprojectrc;
...
public class StatisticsprojectrcTestContainer extends TestContainer {

    public StatisticsprojectrcTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/statisticsprojectrc/app.properties",
    ...
    public static class Common extends StatisticsprojectrcTestContainer {

        public static final StatisticsprojectrcTestContainer.Common INSTANCE = new StatisticsprojectrcTestContainer.Common();
